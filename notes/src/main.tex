...
for which the value of the limit is different. 
...
Then, we can evaluate rho as a single coordinate
...
\begin{gather}
    \lim_{\rho \to 0} \frac{e^{\rho^2 \cos^2\theta + \rho^2 \sin^2\theta} - 1}{\rho^2 \cos^2\theta + \rho^2 \sin^2\theta}\\
    <l'hopital>\\
    \lim_{\rho \to 0} \frac{e^\rho^2 - 1}{r^2}\\
    \lim_{\rho \to 0} \frac{2\rho e^{\rho^2}}{r\rho}\\
    \lim_{\rho \to 0} e^{\rho^2} = 1
\end{gather}
